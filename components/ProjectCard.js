      ...
      <Link href={link} className="group">
        <div className="flex flex-col mb-12 relative">
          <Image
            src={image}
            alt={title}
            className="rounded-lg grayscale-[10%] border border-base-100 dark:border-base-900 transition-all duration-500 ease-in-out group-hover:scale-[1.01] group-hover:grayscale-0 aspect-[16/9] object-cover"
          />
